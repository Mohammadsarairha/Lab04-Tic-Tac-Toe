...
namespace Tic_Tac_Toe_Game
{
	class Game
	{
		...
		public Player Play()
		{
			...
			while (Board.GameBoard[0, 0] == "1" || Board.GameBoard[0,1] == "2" || Board.GameBoard[0, 2] == "3" || Board.GameBoard[1, 0] == "4" || Board.GameBoard[1, 1] == "5" || Board.GameBoard[1, 2] == "6" || Board.GameBoard[2, 0] == "7" || Board.GameBoard[2, 1] == "8" || Board.GameBoard[2,2] == "9")
            {
				Board.DisplayBoard();
